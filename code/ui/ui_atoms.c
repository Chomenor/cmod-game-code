...
void UI_LoadButtonText()
{
	...
	menu_button_text[MBT_VIDEO_LIGHTING_PLAIN][0] = "PLAIN";
	menu_button_text[MBT_VIDEO_LIGHTING_PLAIN][1] = "BASIC PROFILE WITH MODERATE LIGHTING INTENSITY.";
	...
	if ( !Q_stricmp( language, "deutsch" ) ) {
		...
		menu_button_text[MBT_VIDEO_LIGHTING_PLAIN][0] = "SCHLICHT";
		menu_button_text[MBT_VIDEO_LIGHTING_PLAIN][1] = "GRUNDPROFIL MIT MÄSSIGER LICHTINTENSITÄT.";
		...
		menu_button_text[MBT_VIDEO_LIGHTING_PLAIN][0] = "PLAINE";
		menu_button_text[MBT_VIDEO_LIGHTING_PLAIN][1] = "PROFIL DE BASE AVEC INTENSITÉ D'ÉCLAIRAGE MODÉRÉE.";
